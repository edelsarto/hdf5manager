...
from PySide6.QtWidgets import (QApplication, QMainWindow, QTableWidget,
                               QTableWidgetItem, QWidget, QWidgetAction)
...
######### SET UI DEFINITIONS #########
        ...
        widgets.tableWidget_showSearchResult.setEditTriggers(QTableWidget.EditTrigger.NoEditTriggers)    
    ...
    def buttonClick(self):
        ...
        def FillSearchResultTable(dsList):
                ...
                for fds in filteredDsList:
                        ...
                        widgets.tableWidget_showSearchResult.setItem(indX, 0, QTableWidgetItem(str(fds)))
                        indX += 1
        ...
        def FillTable(dsList, itemSel):               
                ...
                with h5py.File("C:/Users/Andrea/Desktop/Hdf5Manager/HDF5 File/NEW TEST/" + widgets.lineEdit_url_1.text() + ".h5", 'r') as hdf:
                        ...
                        tableTest = self.nw.AddTable(toFillArray.shape[0], 2, windowLabel, dsName.split("/")[2])
...
######## SHOW HOME PAGE #########
        ...
        if btnName == "btn_home":
                ...
                print("CURRENT WIDGET: ", widgets.stackedWidget.currentWidget().objectName())
